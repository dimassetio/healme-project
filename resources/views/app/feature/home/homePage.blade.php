    ...
    <div class="w-full bg-white">
        ...
        <section class="mt-7 lg:mt-32 mb-10">
            ...
            <div class="mt-5 lg:mt-14 columns-1 lg:columns-3 px-4 lg:px-8">
                <div class="container rounded-md lg:rounded-2xl pt-4 lg:pt-6 pb-3 lg:pb-4 px-3 lg:px-5 shadow-xl">
                    <img class="block mx-auto w-32 lg:w-48" width="178" src="{{ asset('assets/img/homePage/pic3.png') }}"
                        alt="">
                    <div class="w-auto hidden columns-2 lg:flex items-start">
                        <img class="block my-auto" width="22" src="{{ asset('assets/img/homePage/star.png') }}"
                            alt="" srcset="">
                        <p class="ms-2">5.0</p>
                    </div>
                    <div class="w-auto mt-2 columns-2 flex justify-between lg:pe-5">
                        <div>
                            <p class="font-roboto-regular font-semibold lg:text-lg text-[#42445D]"> Dr. Usma Yousuf</p>
                        </div>
                        <div class="flex items-center">
                            <img class="inline-block w-3" width="16"
                    ...
                    <div class="w-auto lg:hidden columns-2 flex items-start">
                        <img class="block my-auto w-4 lg:w-auto" width="22"
                            src="{{ asset('assets/img/homePage/star.png') }}" alt="" srcset="">
                        <p class="ms-2 text-sm lg:text-base">5.0</p>
                    </div>
                    <div class="pe-1 mt-3 lg:my-3">
                        <p class="font-roboto-regular text-[#42445D] text-sm lg:text-base">Lorem ipsum dolor sit amet,
                    ...
                    <div class="mt-4 lg:mt-2 columns-2 flex justify-start">
                        <button
                            class="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-[#DDD3EF] to-[#C1E7FF] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
                            <span
                                class="relative px-10 py-1 lg:py-2.5 transition-all ease-in duration-75 bg-white  rounded-md text-sm lg:text-[16px]">
                                See detail
                            </span>
                        </button>
                        <button
                            class="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-black px-4 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
                            <svg width="26" height="26" viewBox="0 0 30 29" fill="none" class="w-5 lg:w-auto"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M15 27.5C22.1797 27.5 28 21.6797 28 14.5C28 7.3203 22.1797 1.5 15 1.5C7.8203 1.5 2 7.3203 2 14.5C2 21.6797 7.8203 27.5 15 27.5Z"
                                    fill="black" />
                                <path d="M15 19.7L20.2 14.5L15 9.3" fill="black" />
                                <path
                                    d="M14.1161 18.8161C13.628 19.3043 13.628 20.0957 14.1161 20.5839C14.6043 21.072 15.3957 21.072 15.8839 20.5839L14.1161 18.8161ZM20.2 14.5L21.0839 15.3839C21.572 14.8957 21.572 14.1043 21.0839 13.6161L20.2 14.5ZM15.8839 8.41612C15.3957 7.92796 14.6043 7.92796 14.1161 8.41612C13.628 8.90427 13.628 9.69573 14.1161 10.1839L15.8839 8.41612ZM9.8 13.25C9.10964 13.25 8.55 13.8096 8.55 14.5C8.55 15.1904 9.10964 15.75 9.8 15.75V13.25ZM26.75 14.5C26.75 20.9893 21.4893 26.25 15 26.25V28.75C22.8701 28.75 29.25 22.3701 29.25 14.5H26.75ZM15 26.25C8.51065 26.25 3.25 20.9893 3.25 14.5H0.75C0.75 22.3701 7.12994 28.75 15 28.75V26.25ZM3.25 14.5C3.25 8.01065 8.51065 2.75 15 2.75V0.25C7.12994 0.25 0.75 6.62994 0.75 14.5H3.25ZM15 2.75C21.4893 2.75 26.75 8.01065 26.75 14.5H29.25C29.25 6.62994 22.8701 0.25 15 0.25V2.75ZM15.8839 20.5839L21.0839 15.3839L19.3161 13.6161L14.1161 18.8161L15.8839 20.5839ZM21.0839 13.6161L15.8839 8.41612L14.1161 10.1839L19.3161 15.3839L21.0839 13.6161ZM9.8 15.75H20.2V13.25H9.8V15.75Z"
                                    fill="#EDEDED" />
                            </svg>
                        </button>
                ...
                <div class="container rounded-md lg:rounded-2xl pt-4 lg:pt-6 pb-3 lg:pb-4 px-3 lg:px-5 shadow-xl my-4 lg:my-0">
                    <img class="block mx-auto w-32 lg:w-48" width="178" src="{{ asset('assets/img/homePage/pic3.png') }}"
                        alt="">
                    <div class="w-auto hidden columns-2 lg:flex items-start">
                        <img class="block my-auto" width="22" src="{{ asset('assets/img/homePage/star.png') }}"
