    ...
    <div>
        ...
        <div class="w-full lg:w-[860px] mx-auto mt-10">
            <div class="px-4 lg:px-10">
                <h3 class="font-poppins-regular text-lg lg:text-[28px] font-bold text-center">
                    Permainan Suasana Hati: Mengenal Gangguan Mood
                </h3>
            </div>
            <div class="px-4 lg:px-14 mt-6">
                <p class="text-center text-sm lg:text-[17px] font-poppins-regular">
                    Gangguan mood adalah kelompok gangguan kesehatan mental yang ditandai dengan perubahan suasana hati yang
                    ekstrem dan berlangsung lama. Gangguan ini berbeda dengan fluktuasi emosi normal yang dialami semua
                    orang, karena intensitas, durasi, dan dampaknya yang lebih signifikan terhadap kehidupan sehari-hari
                </p>
            </div>
        </div>
        ...
        <div class="mt-8">
            <div class="w-full lg:w-[300px] flex justify-center mx-auto">
                <a href="{{ route('app.run-test', ['tesType' => 'mood']) }}"
