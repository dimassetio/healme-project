    ...
    <div>
        ...
        <div class="w-full lg:w-[860px] mt-10 mx-auto flex flex-col lg:flex-row lg:flex-wrap items-center lg:justify-center gap-3 lg:gap-[80px]">
            ...
            <a href="{{ route('app.tes-trauma') }}">
                <div class="w-[178px]  h-[186px] bg-white hover:shadow-xl border-4 border-[#121481] rounded-lg">
        ...
        <div class="w-full lg:w-[860px] mx-auto mt-10">
            <div class="px-4 lg:px-10">
                <h3 class="font-poppins-regular text-lg lg:text-[28px] text-center">
                    Trauma: Luka Tak Kasat Mata yang Mempengaruhi Kesehatan Mental
                </h3>
            </div>
            <div class="px-4 lg:px-14 mt-6">
                <p class="text-center text-sm lg:text-[17px] font-poppins-regular">
                    Trauma adalah reaksi emosional yang intens dan berkepanjangan terhadap peristiwa yang sangat menegangkan
                    atau menakutkan. Peristiwa tersebut bisa berupa kekerasan fisik atau seksual, kecelakaan, bencana alam,
        ...
        <div class="mt-8">
            <div class="w-full lg:w-[300px] flex justify-center mx-auto">
                <a href="{{ route('app.run-test', ['tesType' => 'trauma']) }}"
