...
@section('content-runTest')
    <div>
        <div>
            <h4 class="font-poppins-regular text-[24px] font-bold">Apakah Anda Mengalami Depresi?</h4>
        </div>
        ...
        <div class="mt-6 font-poppins-regular">
            <form action="{{ route('app.count-test-stress', ['tesType' => 'depression']) }}" method="POST">
                @csrf
                @method('POST')
                ...
                <div class="mb-8">
                    {{-- question --}}
                    <p class="font-poppins-regular font-semibold">Kurang tertarik atau bergairah dalam melakukan apapun</p>
                    {{-- inputs --}}
                    <div class="mt-3 ps-8">
                ...
                <div class="mb-8">
                    {{-- question --}}
                    <p class="font-poppins-regular font-semibold">Merasa murung, muram, atau putus asa</p>
                    {{-- inputs --}}
                    <div class="mt-3 ps-8">
                        <div class="flex items-center mb-1">
                ...
                <div class="mb-8">
                    {{-- question --}}
                    <p class="font-poppins-regular font-semibold">Sulit tidur atau mudah terbangun, atau terlalu banyak
                        tidur</p>
                    {{-- inputs --}}
                    <div class="mt-3 ps-8">
                        <div class="flex items-center mb-1">
                ...
                <div class="mb-8">
                    {{-- question --}}
                    <p class="font-poppins-regular font-semibold">Merasa lelah atau kurang bertenaga</p>
                    {{-- inputs --}}
                    <div class="mt-3 ps-8">
                        <div class="flex items-center mb-1">
                ...
                <div class="mb-8">
                    {{-- question --}}
                    <p class="font-poppins-regular font-semibold">Kurang nafsu makan atau terlalu banyak makan</p>
                    {{-- inputs --}}
                    <div class="mt-3 ps-8">
                        <div class="flex items-center mb-1">
                ...
                <div class="mb-8">
                    {{-- question --}}
                    <p class="font-poppins-regular font-semibold">Sulit berkonsentrasi pada sesuatu, misalnya membaca koran
                        atau menonton televisi</p>
                    {{-- inputs --}}
                    <div class="mt-3 ps-8">
                        <div class="flex items-center mb-1">
                ...
                <div class="mb-8">
                    {{-- question --}}
                    <p class="font-poppins-regular font-semibold">Kurang percaya diri — atau merasa bahwa Anda adalah orang
                        yang gagal atau telah mengecewakan diri sendiri atau keluarga</p>
                    {{-- inputs --}}
                    <div class="mt-3 ps-8">
                        <div class="flex items-center mb-1">
                ...
                <div class="mb-8">
                    {{-- question --}}
                    <p class="font-poppins-regular font-semibold">Bergerak atau berbicara sangat lambat sehingga orang lain
                        memperhatikannya. Atau sebaliknya — merasa resah atau gelisah sehingga Anda lebih sering bergerak
                        dari biasanya.</p>
                    {{-- inputs --}}
                    <div class="mt-3 ps-8">
                        <div class="flex items-center mb-1">
                ...
                <div class="mb-8">
                    {{-- question --}}
                    <p class="font-poppins-regular font-semibold">Merasa lebih baik mati atau ingin melukai diri sendiri
