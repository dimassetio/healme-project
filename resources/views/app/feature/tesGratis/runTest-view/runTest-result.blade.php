    ...
    <div class="font-poppins-regular text-lg">
        ...
        <style>
            ...
            .card-stress {
                ...
                /* Light pink color for all cards */
                color: #000000;
                /* Black text */
            }
                        ...
                        <div class="card-body text-center font-weight-bold">
                            ...
                            <p class="card-text">
                                <span class="d-block font-weight-bold my-2"
                                    style="font-size: 2.5rem;">{{ $total_anxiety }}</span>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card card-custom-rounded card-depression" style="width: 100%;">
                        <div class="card-body text-center font-weight-bold">
                            ...
                            <p class="card-text">
                                <span class="d-block font-weight-bold my-2"
                                    style="font-size: 2.5rem;">{{ $total_depresi }}</span>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card card-custom-rounded card-stress" style="width: 100%;">
                        <div class="card-body text-center font-weight-bold">
                            ...
                            <p class="card-text">
                                <span class="d-block font-weight-bold my-2"
                                    style="font-size: 2.5rem;">{{ $total_stress }}</span>
        ...
        <p class="mt-2">
            Jika Anda merasa perlu, pertimbangkan untuk bergabung dengan komunitas atau menghubungi psikolog kami untuk
            meningkatkan kesejahteraan mental Anda.
        </p>

        <div class="container mt-10 flex justify-end">
            <a href="{{ route('app.psikolog') }}"
                class="text-white text-sm bg-[#121481] hover:bg-[#3771c2] font-bold rounded-full px-6 py-2 me-2 mb-2">Hubungi
                Psikolog</a>
            <a href="{{ route('app.home') }}"
                class="hover:text-white text-[#121481] text-sm border-2 border-[#121481] hover:bg-[#3771c2] font-bold rounded-full px-6 py-2 me-2 mb-2">Kembali</a>
        </div>
    </div>
