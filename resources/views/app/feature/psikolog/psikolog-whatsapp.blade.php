...
@section('title', 'Whatsapp Psikolog | HealMe')
@section('content')
    <div class="w-full flex items-center">
        <div class="w-[500px] mx-auto my-20 bg-[#FFFAF0] p-8 rounded-xl shadow-2xl border-2 border-gray-300">
            ...
            <p class="text-xl text-center font-poppins-regular mt-5">
                {{ $psikolog->name }}
            </p>
            <div class="container mx-auto font-poppins-regular text-center">
                <a href="https://api.whatsapp.com/send?phone={{ $psikolog->phone_number }}&text=Halo,%20saya%20ingin%20bertanya%20tentang%20konsultasi"
                    class="px-8 py-2 inline-flex items-center my-6 text-center bg-green-600 text-white rounded-xl hover:bg-green-400">
                    <span class="mr-2">chat psikolog</span>
                ...
                <p class="text-sm px-12 opacity-75">Hubungi psikolog anda sekarang untuk informasi selanjutnya.</p>
            </div>
        </div>
    </div>
@endsection
